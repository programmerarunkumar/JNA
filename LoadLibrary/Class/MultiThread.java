...
class LibraryMapping{
	...
	static{
		...
		Native.register("/home/local/ZOHOCORP/arun-pttk3561/JavaNativeAccess/LoadLibrary/libadd.so");
		System.out.println("Instance Loaded");

	}
	public static native int addition(int Number1,int Number2);
...
public class MultiThread extends Thread{
	...
	private int number2;
	private int sum;
	private static LibraryMapping libraryMapping=new LibraryMapping();
	...
	public void run(){
        	...
        	try
        	{  
				this.sum=libraryMapping.addition(this.number1, this.number2);
